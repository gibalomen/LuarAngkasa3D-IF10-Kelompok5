...
//mengambil tekstur img_model_12yellowObject
Image * loadTexture12() {
	Image *image1;
	// alokasi memmory untuk tekstur
	image1 = (Image *) malloc(sizeof(Image));
...
//mengambil tekstur img_model_13planets
Image * loadTexture13() {
	Image *image1;
	// alokasi memmory untuk tekstur
	image1 = (Image *) malloc(sizeof(Image));
	...
	//pic.bmp is a 64x64 picture
	if (!ImageLoad("images//img_model_13planets.bmp", image1)) {
		exit(1);
	}
	return image1;
}
//mengambil tekstur img_model_14planets
Image * loadTexture14() {
	Image *image1;
	// alokasi memmory untuk tekstur
	image1 = (Image *) malloc(sizeof(Image));
	...
	//pic.bmp is a 64x64 picture
	if (!ImageLoad("images//img_model_14planets.bmp", image1)) {
		exit(1);
	}
	return image1;
}
//mengambil tekstur img_model_15planets
Image * loadTexture15() {
	Image *image1;
	// alokasi memmory untuk tekstur
	image1 = (Image *) malloc(sizeof(Image));
	...
	//pic.bmp is a 64x64 picture
	if (!ImageLoad("images//img_model_15planets.bmp", image1)) {
		exit(1);
	}
	return image1;
}
//mengambil tekstur img_model_16planets
Image * loadTexture16() {
	Image *image1;
	// alokasi memmory untuk tekstur
	image1 = (Image *) malloc(sizeof(Image));
	...
	//pic.bmp is a 64x64 picture
	if (!ImageLoad("images//img_model_16planets.bmp", image1)) {
		exit(1);
	}
	return image1;
}
//mengambil tekstur img_model_17planets
Image * loadTexture17() {
	Image *image1;
	// alokasi memmory untuk tekstur
	image1 = (Image *) malloc(sizeof(Image));
	...
	//pic.bmp is a 64x64 picture
	if (!ImageLoad("images//img_model_17planets.bmp", image1)) {
		exit(1);
	}
	return image1;
}
...
//image 12 img_model_12yellowObject
//binding texture untuk membuat texture 2D
...
glPushMatrix();
glTranslatef(1000.0, 350.0, -35.0);
...
glPushMatrix();
glTranslatef(-100.0, -550.0, -200.0);
glRotatef(-15,0.0, 0.0, 01.0);
glRotatef(180,1.0, 0.0, 0.0);
glBindTexture(GL_TEXTURE_2D, texture[17]);
planet();
